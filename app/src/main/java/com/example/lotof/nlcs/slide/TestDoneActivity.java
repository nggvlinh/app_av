...
import com.example.lotof.nlcs.score.ScoreController;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSaveScore.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                tvScore.setText(numTotal+" point");
                ...
                builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        Toast.makeText(TestDoneActivity.this, "Save points successfully!",Toast.LENGTH_LONG).show();
                        finish();
                        dialog.dismiss();
                    }
                });
