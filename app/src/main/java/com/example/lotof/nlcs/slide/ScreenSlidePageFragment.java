...
// lấy cơ sở dữ liệu từ Screen Slide activity.
    ...
    public static ScreenSlidePageFragment create(int pageNumber, int checkAnswer) {
        ...
        // gói dữ liệu lại gói số trang gửi đi
...
//    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        tvNum.setText("Sentence " + (mPageNumber + 1));
        ...
        imgIcon.setImageResource(getResources().getIdentifier(getItem(mPageNumber).getImage()+"","drawable","com.example.lotof.nlcs"));
